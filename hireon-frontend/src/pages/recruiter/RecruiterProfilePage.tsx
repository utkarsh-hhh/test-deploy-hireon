  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-10">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium">Manage your personal information and public presence.</p>
      </div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="space-y-1">
              ...
              <p className="text-violet-600 font-bold uppercase tracking-widest text-[11px]">{user?.role} at Organization</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 max-w-xl">
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800">
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-tighter mb-1">Recruiter ID</p>
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              ...
              <button 
                onClick={() => alert('Public view coming soon!')}
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          { label: 'Jobs Managed', val: '12', color: 'bg-blue-50 text-blue-600', icon: '💼' },
          { label: 'Candidates Hired', val: '45', color: 'bg-emerald-50 text-emerald-600', icon: '🎯' },
          { label: 'Avg Feedback', val: '4.8', color: 'bg-violet-50 text-violet-600', icon: '⭐' },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
